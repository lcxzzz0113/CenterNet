...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='seaships',
                             help='coco | kitti | coco_hp | pascal | chongqing | seaships')
    ...
    self.parser.add_argument('--demo', default='/mnt/data-1/data/lcx/CenterNet-master/data/test-A-image', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    # self.parser.add_argument('--load_model', default='/mnt/data-1/data/lcx/CenterNet-master/models/ctdet_coco_hg.pth',
    #                          help='path to pretrained model')
    self.parser.add_argument('--load_model', default='/mnt/data-1/data/lcx/CenterNet-master/exp/ctdet/default/model_best.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--test_scales', type=str, default='0.5, 1, 2, 3, 4',
    ...
    # loss
    self.parser.add_argument('--mse_loss', action='store_true', default=False,
  ...
  def parse(self, args=''):
    ...
    # opt.data_dir = '/home/users/chenxin.lu/VOCdevkit/VOCdevkit'
    opt.data_dir = '/mnt/data-1/data/lcx/CenterNet-master/data'
