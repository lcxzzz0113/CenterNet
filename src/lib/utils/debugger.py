...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    #   self.names = seaships_name
    elif num_classes == 4 or dataset == 'seaships':
      self.names = seaships_name
    elif num_classes == 10 or dataset == 'chongqing':
      self.names = chongqing_class_name
...
# seaships_name = ['fishing boat','ore carrier','bulk cargo carrier'
#     ,'general cargo ship','container ship','passenger ship']
seaships_name = ['holothurian', 'starfish', 'echinus', 'scallop']
chongqing_class_name = ['c1', 'c2', 'c3', 'c4', 'c5', 'c6', 'c7', 'c8', 'c9', 'c10']
color_list = np.array(
        [
            1.000, 1.000, 1.000,
            0.850, 0.325, 0.098,
